...
export class ManualProvider implements KoreanCardCatalogProvider {
  ...
  getMetadata(): ProviderMetadata { return { providerId: this.providerId, status: "ready", displayName: "官方资料人工维护", coverage: "仅包含管理员已审核发布的官方资料", containsCompleteBenefits: false, contractVersion: "manual-review-v1", message: "PDF/CSV/JSON 提取结果在人工确认前不会成为已验证权益" }; }
