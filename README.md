...
打开终端中显示的本地地址。开发环境没有填写 Supabase 值时可使用带明显标识的会话演示数据；生产环境默认关闭演示并显示配置阻塞。

生产激活从 [PRODUCTION_ACTIVATION.md](./PRODUCTION_ACTIVATION.md) 开始，并使用 [PRODUCTION_CHECKLIST.md](./PRODUCTION_CHECKLIST.md) 逐项验收；代码部署成功不等于外部服务已经激活。
